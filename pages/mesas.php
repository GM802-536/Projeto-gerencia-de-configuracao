...
<body>
    <div class="container">
        ...
        <!-- Legenda -->
        <div class="legenda">
            <span><div class="cor livre"></div> Livre</span>
            <span><div class="cor reservada"></div> Reservada</span>
            <span><div class="cor ocupada"></div> Ocupada</span>
        </div>
        ...
        <div class="mapa-mesas">
            <?php foreach ($mesas as $mesa): ?>
                <div class="mesa-container">
                    <div class="mesa <?= htmlspecialchars($mesa['status']) ?>" 
                         data-id="<?= $mesa['id'] ?>" 
